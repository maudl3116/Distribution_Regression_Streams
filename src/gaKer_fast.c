 ...
 */
        ...
        *((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_R.data + __pyx_t_21 * __pyx_v_R.strides[0]) ) + __pyx_t_22 * __pyx_v_R.strides[1]) ) + __pyx_t_23 * __pyx_v_R.strides[2]) ) + __pyx_t_24 * __pyx_v_R.strides[3]) )) = DBL_MAX;
      }
 ...
 */
      ...
      __pyx_t_27 = 0;
      __pyx_t_28 = 0;
      *((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_R.data + __pyx_t_25 * __pyx_v_R.strides[0]) ) + __pyx_t_26 * __pyx_v_R.strides[1]) ) + __pyx_t_27 * __pyx_v_R.strides[2]) ) + __pyx_t_28 * __pyx_v_R.strides[3]) )) = 0.0;
 ...
 */
            ...
            __pyx_v_eucli_dist = (__pyx_v_eucli_dist + (((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_x.data + __pyx_t_35 * __pyx_v_x.strides[0]) ) + __pyx_t_36 * __pyx_v_x.strides[1]) ) + __pyx_t_37 * __pyx_v_x.strides[2]) ))) - (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_y.data + __pyx_t_38 * __pyx_v_y.strides[0]) ) + __pyx_t_39 * __pyx_v_y.strides[1]) ) + __pyx_t_40 * __pyx_v_y.strides[2]) )))) * ((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_x.data + __pyx_t_41 * __pyx_v_x.strides[0]) ) + __pyx_t_42 * __pyx_v_x.strides[1]) ) + __pyx_t_43 * __pyx_v_x.strides[2]) ))) - (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_y.data + __pyx_t_44 * __pyx_v_y.strides[0]) ) + __pyx_t_45 * __pyx_v_y.strides[1]) ) + __pyx_t_46 * __pyx_v_y.strides[2]) ))))));
          }
 ...
 */
          ...
          *((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_R.data + __pyx_t_47 * __pyx_v_R.strides[0]) ) + __pyx_t_48 * __pyx_v_R.strides[1]) ) + __pyx_t_49 * __pyx_v_R.strides[2]) ) + __pyx_t_50 * __pyx_v_R.strides[3]) )) = (__pyx_v_eucli_dist + __pyx_f_10gaKer_fast__softmin3((*((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_R.data + __pyx_t_46 * __pyx_v_R.strides[0]) ) + __pyx_t_45 * __pyx_v_R.strides[1]) ) + __pyx_t_44 * __pyx_v_R.strides[2]) ) + __pyx_t_43 * __pyx_v_R.strides[3]) ))), (*((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_R.data + __pyx_t_42 * __pyx_v_R.strides[0]) ) + __pyx_t_41 * __pyx_v_R.strides[1]) ) + __pyx_t_40 * __pyx_v_R.strides[2]) ) + __pyx_t_39 * __pyx_v_R.strides[3]) ))), (*((double *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_R.data + __pyx_t_38 * __pyx_v_R.strides[0]) ) + __pyx_t_37 * __pyx_v_R.strides[1]) ) + __pyx_t_36 * __pyx_v_R.strides[2]) ) + __pyx_t_35 * __pyx_v_R.strides[3]) ))), __pyx_v_gamma));
        }
      }
    }
  }
 ...
 */
  ...
  __pyx_t_51.data = __pyx_v_R.data;
  __pyx_t_51.memview = __pyx_v_R.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_51, 0);
  __pyx_t_51.shape[0] = __pyx_v_R.shape[0];
__pyx_t_51.strides[0] = __pyx_v_R.strides[0];
    __pyx_t_51.suboffsets[0] = -1;

__pyx_t_51.shape[1] = __pyx_v_R.shape[1];
__pyx_t_51.strides[1] = __pyx_v_R.strides[1];
...
__pyx_t_3 = __pyx_memoryview_fromslice(__pyx_t_51, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
