...
def exp2(level_sigs,noise_pos,N_bags=100, N_items=15, tspan=np.linspace(0,2*np.pi,100),spec_param = {'a':[1.,3.], 'b':[1.,3.]}):

    # in this experiment, we compare different hyperparameters setting for the signature model.
    example = ellipsis.Ellipsis()
