...
class GP():
    ...
    def __init__(self, X, Y, l_init, var_init, noise_init, param_list, dtype=torch.float64,
        ...
        if 'lengthscale' in param_list:
            ...
            self.lengthscale = torch.nn.Parameter(torch.ones(self.training_data.shape[1], dtype=self.dtype, device=self.device))
    ...
    def K_RBF_eval(self,x1,x2=None):
        ...
        x1 = x1.div(self.transform_softplus(self.lengthscale))
        x2 = x2.div(self.transform_softplus(self.lengthscale))
